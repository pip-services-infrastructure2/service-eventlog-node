...
var plugin = require('service-eventlog-node').EventLogSenecaPlugin;
...
or by using [EventLogSenecaClient](https://github.com/pip-services-infrastructure2/client-eventlog-node/NodeClientApiV1.md/#client_seneca)